...
import { CreateGalleryDto } from '@/modules/gallery/admin/gallery/dtos/create-gallery.dto';
import { UpdateGalleryDto } from '@/modules/gallery/admin/gallery/dtos/update-gallery.dto';
