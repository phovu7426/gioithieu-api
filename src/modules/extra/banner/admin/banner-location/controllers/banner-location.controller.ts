...
import { BannerLocationService } from '@/modules/extra/banner/admin/banner-location/services/banner-location.service';
import { CreateBannerLocationDto } from '@/modules/extra/banner/admin/banner-location/dtos/create-banner-location.dto';
import { UpdateBannerLocationDto } from '@/modules/extra/banner/admin/banner-location/dtos/update-banner-location.dto';
