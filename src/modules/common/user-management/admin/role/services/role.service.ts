...
import { IRoleRepository, ROLE_REPOSITORY, RoleFilter } from '@/modules/common/user-management/repositories/role.repository.interface';
import { IPermissionRepository, PERMISSION_REPOSITORY } from '@/modules/common/user-management/repositories/permission.repository.interface';
import { IUserRoleAssignmentRepository, USER_ROLE_ASSIGNMENT_REPOSITORY } from '@/modules/rbac/repositories/user-role-assignment.repository.interface';
