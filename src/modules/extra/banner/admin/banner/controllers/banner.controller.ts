...
import { BannerService } from '@/modules/extra/banner/admin/banner/services/banner.service';
import { CreateBannerDto } from '@/modules/extra/banner/admin/banner/dtos/create-banner.dto';
import { UpdateBannerDto } from '@/modules/extra/banner/admin/banner/dtos/update-banner.dto';
