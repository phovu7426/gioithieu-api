...
import { CreateBannerDto } from '@/modules/extra/banner/admin/dtos/create-banner.dto';
import { UpdateBannerDto } from '@/modules/extra/banner/admin/dtos/update-banner.dto';
